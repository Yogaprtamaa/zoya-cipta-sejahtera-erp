...
/** POST /api/order — agent creates a PO. Status auto-escalates by director threshold. */
export async function POST(req: Request) {
  ...
  const status: "director_review" | "admin_review" = totalValue >= db.settings.director_threshold ? "director_review" : "admin_review";
